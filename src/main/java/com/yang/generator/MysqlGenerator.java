...
//    private static String table="t1";                  //table名字
...
//        tableFillList.add(new TableFill("age", FieldFill.INSERT_UPDATE));
//        // 代码生成器
...
//                // 自定义 controller 父类
////                .setSuperControllerClass("com.yang."+packageName+".controller.AbstractController")
